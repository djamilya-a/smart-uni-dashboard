    ...
    <main className='w-full bg-[#141621]'>
      <div className="w-[1400px] mx-auto flex justify-between items-center">
        <div className="border border-[3px] border-[#0c3561] py-[50px] pl-[70px] pr-[100px] rounded-[15px]">
          <h1 className='text-[46px] font-semibold text-[#fffcf6]'>C возвращениeм, <br /> Бегимай!</h1>
        ...
        <div className="flex flex-col gap-[20px]">
          <div className="min-h-screen bg-[#141621] text-[#141621] flex flex-row items-center gap-8 p-8 text-[18px]">
            <div className="flex gap-6 flex-wrap justify-center ml-[70px]">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-[#141621] text-[#fffcf6] rounded-lg p-2 mt-3 hover:bg-[#0c3561] transition"
              >
                Добавить
              </button>
            </form>
